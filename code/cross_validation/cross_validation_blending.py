...
class CrossValidationBlending:
    ...
    def add_model(self, function, name):
        ...
        Args:
            function (function): function that, given train, test and possibly other parameters returns the predictions computed on the test dataset.
            name (str): string representing the model name
        """
    ...
    def add_params_for_model(self, model_name, params_dict, compute_predictions=True):
        ...
        Args:
            ...
            params_dict (dict): containing the optional parameters to be passed to the model function
            compute_predictions (bool): if compute automatically the predictions for this set of params
        """
    ...
    def compute_predictions(self, model):
        ...
        Args:
            model (string): the model for which computing the predictions
    ...
    def evaluate_blending(self, blending_dict):
        ...
        Args:
            blending_dict (dict): in the form {'movie_mean':0,'user_mean':0,'global_mean':1}
        """
