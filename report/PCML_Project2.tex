...
Active Collaborative Filtering Recommender Systems for movie collection blending 12 different methods (8 direct scoring methods and 4 iterative ones) in order to achieve around 0.977 RMSE on Kaggle's EPFL ML Recommender System challenge. 
\end{abstract}
